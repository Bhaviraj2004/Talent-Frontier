      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6">
          {services.map((service, idx) => {
            ...
            return (
              <div key={idx} className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow flex flex-col relative overflow-hidden group">
                <div className="text-blue-600 mb-6">
                  <Icon className="w-8 h-8" strokeWidth={2} />
                </div>
                <h3 className="text-lg font-bold text-[#0f172a] mb-3 whitespace-pre-line leading-tight">
                  {service.title}
                </h3>
