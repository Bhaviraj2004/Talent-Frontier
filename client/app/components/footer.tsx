...
export default function Footer() {
  return (
    <footer className="w-full flex flex-col lg:flex-row font-sans">
      ...
      {/* Left Column (Light) */}
      <div className="w-full lg:w-[30%] xl:w-[25%] bg-white p-6 sm:p-10 md:p-12 lg:p-16 flex flex-col justify-between">
        <div>
          <Link href="/" className="block mb-6 sm:mb-8">
            <img src="/logo.png" alt="Talent Frontier Logo" className="h-12 sm:h-16 md:h-20 w-auto object-contain" />
          </Link>
          
          <div className="w-12 h-0.5 bg-[#0f172a] mb-6 sm:mb-8"></div>
          
          <p className="text-[#334155] text-sm leading-relaxed mb-8 sm:mb-12">
        ...
        <div className="text-[#334155] text-xs sm:text-sm font-medium mt-6 lg:mt-0">
      ...
      {/* Right Column (Dark) */}
      <div className="w-full lg:w-[70%] xl:w-[75%] bg-[#081a40] p-6 sm:p-10 md:p-12 lg:p-16 flex flex-col justify-between">
        
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-6 mb-12 sm:mb-16">
          {/* Company */}
          <div>
            <h3 className="text-white text-lg sm:text-xl font-normal mb-4 sm:mb-6">Company</h3>
          ...
          {/* Services */}
          <div>
            <h3 className="text-white text-lg sm:text-xl font-normal mb-4 sm:mb-6">Services</h3>
            <ul className="flex flex-col gap-3 sm:gap-4">
              ...
              <li><Link href="/services/Brand-Marketing" className="text-slate-300 hover:text-white transition-colors text-sm leading-tight block">Brand, Marketing & Creative Support</Link></li>
          ...
          {/* Industries */}
          <div>
            <h3 className="text-white text-lg sm:text-xl font-normal mb-4 sm:mb-6">Industries</h3>
            <ul className="flex flex-col gap-3 sm:gap-4">
          ...
          {/* Contact Us */}
          <div>
            <h3 className="text-white text-lg sm:text-xl font-normal mb-4 sm:mb-6">Contact Us</h3>
            <ul className="flex flex-col gap-4 sm:gap-5">
              <li className="flex items-start gap-3">
                <div className="w-7 h-7 rounded-full bg-[#1c55d4] flex items-center justify-center flex-shrink-0 mt-0.5">
                  <Phone className="w-3.5 h-3.5 text-white" />
                </div>
                <a href="tel:+61XXXXXXXXX" className="text-slate-300 hover:text-white transition-colors text-sm mt-1">+61 XXX XXX XXX</a>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-7 h-7 rounded-full bg-[#1c55d4] flex items-center justify-center flex-shrink-0 mt-0.5">
                  <Mail className="w-3.5 h-3.5 text-white" />
                </div>
                <a href="mailto:admin@talentfrontier.com.au" className="text-slate-300 hover:text-white transition-colors text-sm break-all mt-1">admin@talentfrontier.com.au</a>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-7 h-7 rounded-full bg-[#1c55d4] flex items-center justify-center flex-shrink-0 mt-0.5">
