        ...
        <div className="bg-[#08154a] rounded-[24px] md:rounded-[32px] overflow-hidden flex flex-col lg:flex-row items-center justify-between shadow-xl">
          ...
          <div className="w-full lg:w-[50%] p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
            ...
            <div className="flex flex-wrap gap-4 items-center">
              <Link
                href="/contact"
                className="bg-white text-[#08154a] hover:bg-gray-100 active:bg-blue-50 active:scale-[0.98] active:brightness-105 px-6 py-3.5 rounded-md font-semibold text-[13px] sm:text-[14px] transition-all shadow-md text-center"
              >
                Discuss Your Business Needs
              </Link>
              <Link
                href="/contact"
                className="bg-transparent hover:bg-white/10 active:bg-white/20 active:scale-[0.98] text-white border border-white/30 px-6 py-3.5 rounded-md font-semibold text-[13px] sm:text-[14px] transition-all text-center"
              >
                Talk to Our Team
              </Link>
            </div>
