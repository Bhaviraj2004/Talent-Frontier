      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-start">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            ...
            <Link href="/our-services" className="bg-white border border-[#1d4ed8] text-[#1d4ed8] hover:bg-blue-50 font-semibold py-3.5 px-6 rounded-md text-[13px] text-center transition-colors">
