...
export default function HeroSection() {
  return (
    <section className="relative w-full aspect-[1440/656] sm:aspect-auto sm:h-[340px] md:h-[480px] lg:h-[580px] flex items-center justify-center overflow-hidden bg-[#354964]">
      {/* Background Image */}
