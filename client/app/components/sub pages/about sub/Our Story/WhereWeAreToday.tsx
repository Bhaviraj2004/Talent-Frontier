...
export default function WhereWeAreToday() {
  return (
    <section className="w-full bg-[#f4f7fb] py-10 sm:py-14 px-4 md:px-8">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 lg:gap-20">
        {/* Left Content Area */}
        <div className="w-full md:w-1/2 flex flex-col justify-center">
          <h2 className="text-3xl md:text-4xl font-bold text-[#1a2332] mb-6 sm:mb-8">
            Where We Are Today
          </h2>
        ...
        {/* Right Image Area */}
        <div className="w-full md:w-1/2 relative aspect-[16/9] md:aspect-auto md:h-[420px] rounded-2xl md:rounded-[32px] overflow-hidden shadow-lg border border-gray-100 group transition-all duration-300 hover:shadow-2xl">
          <Image
