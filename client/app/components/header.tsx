    ...
    <header className="w-full bg-[#f4f7fc]">
      <div className="flex items-center justify-between px-6 py-5 md:px-12 max-w-[1400px] mx-auto w-full font-sans">
        ...
        <nav className="hidden lg:flex items-center gap-8 text-[15px] font-bold text-[#1e293b]">
          <Link href="#" className="text-[#2563eb] hover:text-[#2563eb] transition-colors">Home</Link>
          <Link href="#" className="hover:text-[#2563eb] transition-colors">About</Link>
          <Link href="#" className="hover:text-[#2563eb] transition-colors">Services</Link>
          <Link href="#" className="hover:text-[#2563eb] transition-colors">Industries</Link>
          <Link href="#" className="hover:text-[#2563eb] transition-colors">Testimonials</Link>
          <Link href="#" className="hover:text-[#2563eb] transition-colors">Blog</Link>
