...
export default function IndustriesHero() {
  return (
    <section className="relative w-full min-h-[460px] md:min-h-[600px] lg:min-h-[650px] bg-[#02091a] overflow-hidden flex items-center font-sans py-12 md:py-20">
      {/* Background Image */}
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16 flex flex-col">
        <div className="max-w-[650px] mt-4 md:mt-8">
          ...
          <p className="text-gray-300 text-[14px] md:text-[15px] max-w-[480px] mb-8 md:mb-12 leading-relaxed font-light">
