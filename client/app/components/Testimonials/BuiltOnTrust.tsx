  ...
  return (
    <section className="w-full bg-white py-16 sm:py-20 lg:py-24 font-sans">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-12 lg:px-16">
        ...
        {/* Top Text */}
        <div className="flex flex-col md:flex-row justify-between items-start gap-6 sm:gap-8 mb-12 sm:mb-16 lg:mb-20">
          <h2 className="text-[26px] sm:text-[34px] md:text-[42px] font-bold text-[#1e293b] leading-[1.15] tracking-tight md:max-w-[45%]">
            Built on Trust and Consistent Delivery
          </h2>
          <p className="text-gray-600 text-[13px] sm:text-[14px] leading-relaxed md:max-w-[45%] font-medium md:mt-3">
        ...
        {/* Bottom Divider */}
        <div className="flex items-center gap-2 sm:gap-4 lg:gap-8 w-full max-w-[1100px] mx-auto">
          <div className="h-[1px] sm:h-[2px] flex-1 bg-slate-200"></div>
          <span className="text-[#2563eb] font-bold text-[12px] sm:text-[15px] lg:text-[18px] tracking-wide text-center px-2">
