      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16 flex flex-col py-20">
        <div className="max-w-[650px] mt-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-4">
            ...
            <button className="bg-transparent hover:bg-white/5 border border-[#1d4ed8] text-[#3b82f6] hover:text-[#60a5fa] px-8 py-3.5 rounded-md font-semibold text-[13px] transition-colors text-center">
              Book a Consultation
            </button>
          </div>
        </div>
