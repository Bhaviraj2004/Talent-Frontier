      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16 flex flex-col py-20">
        <div className="max-w-[650px] mt-8">
          ...
          <p className="text-gray-300 text-[14px] md:text-[15px] max-w-[480px] mb-12 leading-relaxed font-light">
            Practical perspectives on business operations, technology, finance, workforce planning and sustainable growth.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-4">
            ...
            <button className="bg-transparent hover:bg-white/5 border border-[#1d4ed8] text-[#3b82f6] px-8 py-3.5 rounded-md font-semibold text-[13px] transition-colors text-center">
              Browse All Topics
            </button>
          </div>
        </div>
